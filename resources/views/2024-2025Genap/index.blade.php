...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5 mb-6">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-xl font-bold text-gray-800">2024/2025 Genap</p>
        </div>
...
<div class="grid grid-cols-1 md:grid-cols-4 gap-5 mb-6">
    ...
    <div class="bg-gradient-to-br from-orange-500 to-orange-600 text-white p-6 rounded-2xl shadow-lg relative overflow-hidden">
        <div class="relative z-10">
            ...
            <p class="text-4xl font-bold">71.5</p>
    ...
    <div class="bg-gradient-to-br from-green-500 to-green-600 text-white p-6 rounded-2xl shadow-lg relative overflow-hidden">
        <div class="relative z-10">
            ...
            <p class="text-4xl font-bold">3.58</p>
    ...
    <div class="grid grid-cols-5 gap-4">
        @php
            $gradeDistribution = [
                ...
                ['grade' => 'B+', 'count' => 1, 'color' => 'blue', 'percentage' => 11],
                ['grade' => 'B', 'count' => 3, 'color' => 'yellow', 'percentage' => 33],
                ['grade' => 'C', 'count' => 0, 'color' => 'orange', 'percentage' => 0],
...
<div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
    <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-5 border-b border-gray-200">
        <h2 class="text-xl font-bold text-gray-800">Nilai Semester 2024/2025 Genap</h2>
        ...
        @php
            $courses = [
                [
                    'no' => 1,
                    'kode' => '	RPL42308',
                    'nama' => '	Animasi dan Desain Multimedia',
                    'nilai_angka' => '82.75',
                    'nilai_huruf' => 'A',
                    'indeks' => '4.00',
                    'sks' => '3.00',
                ...
                [
                    'no' => 4,
                    'kode' => '	RPL42307',
                    'nama' => 'Kerangka Kerja Pengembangan Antarmuka Website',
                    'nilai_angka' => '77.24',
                    'nilai_huruf' => 'B+',
                    'indeks' => '3.50',
                    'sks' => '3.00',
                ...
                [
                    'no' => 7,
                    'kode' => 'RPL42306',
                    'nama' => 'Praktik Algoritma dan Pemrograman',
                    'nilai_angka' => '73.50',
                    'nilai_huruf' => 'B',
                    'indeks' => '3.00',
                    'sks' => '3.00',
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-8">
                    ...
                    <div>
                        ...
                        <p class="text-3xl font-bold text-orange-600">71.5</p>
                    </div>
                </div>
                <div class="text-right">
                    <p class="text-sm text-gray-600 mb-1">INDEKS PRESTASI SEMESTER</p>
                    <p class="text-5xl font-bold text-green-600">3.58</p>
                </div>
            </div>
        </div>
    </div>
